...
public class lista5 {
    ...
    public static void E (){
        String telefones = """
            ...
            """;
        String[] listaTelefones = telefones.split("\\s+");
        int count = 0;
        for (String s : listaTelefones){
            boolean consec = false;
            boolean soma = false;
            boolean igual = false;
            char prim = s.charAt(0);
            char ult = s.charAt(s.length()-1);
            if (prim == ult){
                igual = true;
            }
            int localSum = 0;
    ...
    public static boolean consec (String s){
        for (int i = 0; i < s.length() - 1; i++){
            if (s.charAt(i) == s.charAt(i+1)){
                return true;
            }
    ...
    public static boolean somaPar (String s){
        int soma = 0;
    ...
    public static boolean pontasIguais (String s){
        return s.charAt(0) == s.charAt(s.length()-1);
    }

    public static void telefonesValidos (){
        String telefones = """
        213752 216732 221063 221545 225583 229133 230648 233222 
        236043 237330 239636 240138 242123 246224 249183 252936 
        254711 257200 257607 261424 263814 266794 268649 273050 
        ...
        int count = 0;
        for (String s : listaTelefones){
            if (somaPar(s) && !pontasIguais(s) && !consec(s)){
                count += 1;
            }
        }
        System.out.println(count);
